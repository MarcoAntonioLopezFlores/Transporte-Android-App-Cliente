...
class LocationUpdatesService: Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name: CharSequence = getString(com.app.expresstaxi.R.string.app_name)
        ...
        get() {
            ...
            val builder =
                NotificationCompat.Builder(this)
                    .addAction(
                        com.app.expresstaxi.R.mipmap.ic_launcher, "Abrir",
                        activityPendingIntent
                    )
                    .addAction(
                        com.app.expresstaxi.R.mipmap.ic_launcher, "Detener ubicación",
                    ...
                    .setSmallIcon(com.app.expresstaxi.R.drawable.ic_location_drop)
    ...
    companion object {
        ...
        private const val PACKAGE_NAME =
            "com.google.android.gms.location.expresstaxi.LocationUpdatesService"
